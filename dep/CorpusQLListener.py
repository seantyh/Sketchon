...
class CorpusQLListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by CorpusQLParser#positionLongPartAttValuePair.
    def enterPositionLongPartAttValuePair(self, ctx:CorpusQLParser.PositionLongPartAttValuePairContext):
        pass

    # Exit a parse tree produced by CorpusQLParser#positionLongPartAttValuePair.
    def exitPositionLongPartAttValuePair(self, ctx:CorpusQLParser.PositionLongPartAttValuePairContext):
        pass


    # Enter a parse tree produced by CorpusQLParser#positionLongPartParenthesised.
    def enterPositionLongPartParenthesised(self, ctx:CorpusQLParser.PositionLongPartParenthesisedContext):
        pass

    # Exit a parse tree produced by CorpusQLParser#positionLongPartParenthesised.
    def exitPositionLongPartParenthesised(self, ctx:CorpusQLParser.PositionLongPartParenthesisedContext):
        pass


    # Enter a parse tree produced by CorpusQLParser#positionLongPartNegated.
    def enterPositionLongPartNegated(self, ctx:CorpusQLParser.PositionLongPartNegatedContext):
        pass

    # Exit a parse tree produced by CorpusQLParser#positionLongPartNegated.
    def exitPositionLongPartNegated(self, ctx:CorpusQLParser.PositionLongPartNegatedContext):
        pass
